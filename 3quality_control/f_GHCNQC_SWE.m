function [Qflag_tswe]=f_GHCNDQC_SWE(swe,date,NEcal)
...
d1km=lldistkm(double(lle(tarind,1)),double(lle(tarind,2)),double(lle(:,1)),double(lle(:,2)));
d1km(tarind)=nan;

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% function f_save_stn(Outfile,ID,LLE,date,prcp,tmin,tmax,prcp_qfraw,tmin_qfraw,tmax_qfraw,prcp_qf,tmin_qf,tmax_qf,mflag,overwrite)
% Function creates a netcdf file; If you copy and paste code into the Matalb terminal it seems to work. %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
ncwrite(Outfile,'LLE',double(LLE));
...
% write variables
prcp(isnan(prcp))=-999;
nccreate(Outfile,'prcp','Datatype','double','Dimensions',{'nday',nday,'nstn',nstn},'Format','netcdf4','DeflateLevel',9,'FillValue',-999);
ncwrite(Outfile,'prcp',prcp);
ncwriteatt(Outfile,'prcp','description','precipitation (mm/d)');
% clear prcp

tmin(isnan(tmin))=-999;
nccreate(Outfile,'tmin','Datatype','double','Dimensions',{'nday',nday,'nstn',nstn},'Format','netcdf4','DeflateLevel',9,'FillValue',-999);
ncwrite(Outfile,'tmin',tmin);
ncwriteatt(Outfile,'tmin','description','minimum temperature (C)');
% clear tmin

tmax(isnan(tmax))=-999;
nccreate(Outfile,'tmax','Datatype','double','Dimensions',{'nday',nday,'nstn',nstn},'Format','netcdf4','DeflateLevel',9,'FillValue',-999);
